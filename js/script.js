$(".owl-carousel9").owlCarousel({
 ...
 $('#clientowls').owlCarousel({
	...
	$(document).ready(function(){
		...
		function fun1(){
		document.getElementById('mainimg-change').innerHTML = "<img src='img/headphone-shop1.jpg'>";
		}
		function fun2(){
		document.getElementById('mainimg-change').innerHTML = "<img src='img/hello-pro1.jpg'>";
		}
		function fun3(){
		document.getElementById('mainimg-change').innerHTML = "<img src='img/lead-head-shop1.jpg'>";
		}
		function fun4(){
		document.getElementById('mainimg-change').innerHTML = "<img src='img/17-600x600.jpg'>";
		}
         ...
         $(document).ready(function(){
           ...
           $(".industriesCenter.bannerSlider2 .col4").hover(function() {
