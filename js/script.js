$(".service-item1").click(function () {
  $(".service-item").removeClass("active");
  $(".service-item1").addClass("active");
  $(".service-content").removeClass("active");
  $(".service-content1").addClass("active");
});
$(".service-item2").click(function () {
  $(".service-item").removeClass("active");
  $(".service-item2").addClass("active");
  $(".service-content").removeClass("active");
  $(".service-content2").addClass("active");
});
$(".service-item3").click(function () {
  $(".service-item").removeClass("active");
  $(".service-item3").addClass("active");
  $(".service-content").removeClass("active");
  $(".service-content3").addClass("active");
});
$(".service-item4").click(function () {
  $(".service-item").removeClass("active");
  $(".service-item4").addClass("active");
  $(".service-content").removeClass("active");
  $(".service-content4").addClass("active");
});
$(".service-item5").click(function () {
  $(".service-item").removeClass("active");
  $(".service-item5").addClass("active");
  $(".service-content").removeClass("active");
  $(".service-content5").addClass("active");
});
$(".service-item6").click(function () {
  $(".service-item").removeClass("active");
  $(".service-item6").addClass("active");
  $(".service-content").removeClass("active");
  $(".service-content6").addClass("active");
});
